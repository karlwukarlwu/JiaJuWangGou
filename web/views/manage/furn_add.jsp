    ...
    <script type="text/javascript">
        $(function () {
            $("input[type='submit']").click(function () {
                ...
                if (name == "" || maker == "" || price == "" || sales == "" || stock == "") {

                    $("span[class='errorMsg']").html("请填写完整信息");
                    return false;
                }
                let pattern0 = /^(?!0(\.0+)?$)(\d+|\d*\.\d+)$/
 //               只接受正数


                let pattern1 = /^(?:[0-9]|[1-9][0-9]|([1-9][0-9]{2}))$/;
                //0-999


                if(!pattern0.test(price)){
                    $("span[class='errorMsg']").html("价格格式不正确");
                    return false;
                }
                if(!pattern1.test(sales)){
                    $("span[class='errorMsg']").html("销量格式不正确");
                    return false;
                }
                if(!pattern1.test(stock)){
                    $("span[class='errorMsg']").html("库存格式不正确");
                    return false;
                }
                return true;
            })
                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <span style="font-size: 18pt;font-weight: bold;float: right;color: red;"
                                  class="errorMsg">${requestScope.msg}</span>
                            <tbody>
                            <tr>
