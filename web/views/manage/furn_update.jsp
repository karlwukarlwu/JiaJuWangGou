...
<%--                当form表单中要提交图片和文本的时候 要开始修改enctype--%>
                <form action="manage/furnServlet?id=${requestScope.furn.id}&action=updateFurn&pageNo=${requestScope.pageNo}" method="post" enctype="multipart/form-data">
                    <%--                    这里是需要隐藏域来拿id的因为 BeanUtils.populate()方法需要完整的参数进行反射--%>
<%--                    当变成  enctype="multipart/form-data" 时 一下的表单项不好获取 直接写入url里面比较方便--%>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    ...
                                    <img id = "prevView" class="img-responsive ml-3"
                                                     ...
                                                     alt=""/>
                                        <input type="file" name="pic" onchange="prev(this)"/>
                                    </a>
                                    </div>
                                </td>
                                ...
                                <td class="product-sales-quantity">
