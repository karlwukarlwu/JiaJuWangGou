    ...
    <script type="text/javascript">
        $(function () {
            $("a.deleteCss").click(function () {
                ...
                //confirm 是js的一个弹出框
                return confirm("确定要删除" + furnName + "吗？");
            })
            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <div class="header-bottom-set dropdown">
                            <%--                           他的需求是当完成添加以后 仍回到发起添加的那一页 因此这样写 想定位最后一样pageNo 改成pageTotalCount--%>
    ...
    <div class="container">
                ...
                <form action="#">
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <%--                            更新了 用分页 这个调用属性本质是调用了page的getItems 方法--%>
        ...
        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
            <ul>
                ...
                <%--                    用set标签设置变量--%>
                <%--    规则 如果总页数小于5 全部显示
                    如果总页数大于5  则显示当前页的前两页和后两页
                    如果当前页小于3 则显示前5页
                    如果当前页是后三页 则显示后5页
                    如果当前页在中间 则显示当前页的前两页和后两页
                --%>
                <c:choose>
                ...
                <div class="row flex-sm-row-reverse">
                    <div class="col-md-6 text-right">
                        <div class="payment-link">
                            <%--                            #会请求当前页 当前页是    base href="<%=request.getContextPath()+'/'%>" --%>
                            <%--                            这会导致调用另一个customerServlet--%>
                            <img src="#" alt="">
                        </div>
                    </div>
