    ...
    <script>
        $(function () {
            ...
            $("button.add-to-cart").click(function () {
                ...
                //     Ajax请求 搭配前端
                //     引出问题 因为没有跳转 那么没有登录的时候无法通过加入购物车跳转到登录页面
                $.getJSON("cartServlet", "action=addItemByAjax&id=" + furnId, function (data) {
                    // console.log(data)
                    // 登录和没有登录 返回的data属性不一致 通过这个进行判断
            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="customerFurnServlet">
                                    <%--                                    getParameter 会去找 name属性 拿到的是value的值--%>
                                    <input class="form-control" name="name" placeholder="Enter your search key"
                                           type="text">
                                    <input name="action" type="hidden" value="pageByName">
                                    <button class="submit" type="submit"><i class="icon-magnifier"></i></button>
                                </form>
                            </div>
                        </div>
                        <!-- Single Wedge Start -->
                        <%--                        通过session和 el表达式来显示不同的菜单--%>
                        ...
                        <%--              offcanvas-toggle 在jQuery中被处理了 所以我们可以将这个去掉 如何搜到这个 在find in file 中搜这个名字来找到什么地方出问题了             --%>
            ...
            <div class="col">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tab-product-new-arrivals">
                        <div class="row">
                            <%--                            因为这些页面理论上是先调用servlet 再转发到这个页面 所以对象的属性值是算出来的--%>
                            <%--                            这个page是一个对象 他的属性什么的都是在service层算出来的 因此可以实时变化--%>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <c:if test="${furn.stock==0}">
                                                <button title="Add To Cart" furnId="${furn.id}" disabled
                                                        class=" add-to-cart">缺货
                                                </button>
                                            </c:if>
                                            <c:if test="${furn.stock!=0}">
